...
use Jane\Bundle\AutoMapperBundle\Cache\GeneratorWarmupLoaderInterface;
...
class JaneAutoMapperExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->registerForAutoconfiguration(GeneratorWarmupLoaderInterface::class)->addTag('jane_auto_mapper.generator_warmup_loader');
    }
}
